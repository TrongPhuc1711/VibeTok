...
export default function RegisterPage() {
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        try { await register(form); navigate(ROUTES.HOME); }
        catch (e) { setApiError(e.message || 'Đăng ký thất bại'); }
        ...
        <div className="min-h-screen bg-base flex font-body">
            ...
            <div className="flex-1 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center select-none">
                    ...
                    <p className="text-text-subtle text-[13px] tracking-[2.34px] mb-6 uppercase">FEEL THE VIBE</p>
            ...
            <div className="w-[480px] bg-surface border-l border-border flex flex-col justify-center px-10 py-12 gap-4 overflow-auto">
                <div>
                    <h2 className="font-display font-bold text-[28px] text-white mb-1.5">Tạo tài khoản 🎬</h2>
                ...
                <FormInput label="Họ và tên" value={form.fullName}
                    onChange={set('fullName')} onBlur={v => validateField('fullName', v)}
                    placeholder="Nguyễn Vibe" error={errors.fullName} required />

                <FormInput label="Email" type="email" value={form.email}
                    onChange={set('email')} onBlur={v => validateField('email', v)}
                    placeholder="email@example.com" error={errors.email} required />
                ...
                <FormInput label="Mật khẩu" type="password" value={form.password}
                    ...
                    hint="Cần có chữ hoa, chữ thường và số" required />
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`w-full bg-elevated border rounded-lg px-4 py-4 text-sm font-body outline-none transition-colors [color-scheme:dark]
                    ...
                    {errors.birthDate
                        ...
                        : age !== null && (
                            <p className="text-text-faint text-xs mt-1.5">
                                Tuổi: <span className={age >= MIN_AGE ? 'text-emerald-400' : 'text-primary'}>{age} tuổi</span>
