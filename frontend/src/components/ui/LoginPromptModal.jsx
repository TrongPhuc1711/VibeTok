...
/**
 * LoginPromptModal — popup kiểu TikTok khi chưa đăng nhập
 * Hiển thị khi user cố tương tác (like, comment, follow...)
 *
 * Props:
 *  open    – boolean
 *  onClose – () => void
 *  action  – 'like' | 'comment' | 'follow' | 'bookmark' | 'share' (tùy chọn, để hiện text phù hợp)
 */
