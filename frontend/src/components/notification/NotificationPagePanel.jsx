...
const TYPE_CONFIG = {
    like: { BadgeIcon: LikeNotifIcon, color: '#ff2d78', bg: '#ff2d7820', text: 'đã thích ảnh của bạn' },
...
function NotifItem({ notif, onClick }) {
    ...
    return (
        ...
        >
            ...
            {/* Video thumb */}
            {notif.meta?.videoId && (
                <div className="w-10 h-14 rounded shrink-0 bg-gradient-to-br from-[#1a1a2e] to-[#0a0a1a] border border-border2 flex items-center justify-center text-[13px]">
                    🎬
                </div>
            )}
